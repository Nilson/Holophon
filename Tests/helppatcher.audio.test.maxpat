...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.666672, 131.0, 116.0, 53.0 ],
					"text" : "jmod.holoReccontrol jmod.holoSoundcues~ jmod.holoTransport"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.test.assert.equal.old \"TEST Holophon NoErrorsRunningDSPinHelpPatchers\" 0"
				}
