	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"orientation" : 2,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.0, 109.0, 17.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 2,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.0, 349.0, 17.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 71.0, 349.0, 100.0, 100.0 ],
					"rightmargin" : 4,
					"rightvalue" : 100,
					"topmargin" : 4,
					"topvalue" : 100
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 33.0, 71.0, 31.0, 17.0 ],
									"text" : "% 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 33.0, 51.0, 34.0, 17.0 ],
									"text" : "+ 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 33.0, 93.0, 41.0, 17.0 ],
									"text" : "* 360."
								}
...
,
					"patching_rect" : [ 71.0, 187.0, 55.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"orientation" : 2,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 114.0, 31.0, 90.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 125.0, 57.0, 57.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "polar 2 cartesian coordinates converter",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 139.5, 208.0, 131.5, 208.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"hidden" : 0,
					"midpoints" : [ 131.5, 343.0, 161.5, 343.0 ],
					"source" : [ "obj-5", 0 ]
				}
